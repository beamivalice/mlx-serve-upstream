...
- Xing4.0-29B-A4B supports original BF16 and mixed affine 4-bit MoE/8-bit dense weights, compressed MLA caching, thinking, and tool calls; MTP is not enabled.
